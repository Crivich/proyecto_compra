    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Restaurant "Rancho"</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav pull-right">
            <li>
              <a href="" class="btn">CARRITO <span class="badge"><?php print cantidadPlatos(); ?></span></a>
            </li> 
          </ul>
        </div><!--/.nav-collapse -->
      </div>
            ...
            <table class="table table-bordered table-hover">
                      ...
                      ?>
                        <tr>
                            <form action="actualizar_carrito.php" method="post">
                                ...
                                <td><?php print $value['precio']  ?> Bol</td>
                                <td>
                ...
                <tfoot>
                        <tr>
                            ...
                            <td><?php print calcularTotal(); ?> Bolivianos</td>
                            <td></td>
                        </tr>
